...
public class TypeSpecOperationSignatureReferenceNodeImpl extends TypeSpecElementImpl implements TypeSpecOperationSignatureReferenceNode {

  public TypeSpecOperationSignatureReferenceNodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TypeSpecVisitor visitor) {
    visitor.visitOperationSignatureReferenceNode(this);
  }
