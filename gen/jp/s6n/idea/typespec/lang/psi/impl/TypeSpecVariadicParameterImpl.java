...
public class TypeSpecVariadicParameterImpl extends TypeSpecElementImpl implements TypeSpecVariadicParameter {

  public TypeSpecVariadicParameterImpl(@NotNull ASTNode node) {
    super(node);
  }
