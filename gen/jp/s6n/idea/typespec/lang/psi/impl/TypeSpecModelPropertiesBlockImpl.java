...
public class TypeSpecModelPropertiesBlockImpl extends TypeSpecElementImpl implements TypeSpecModelPropertiesBlock {

  public TypeSpecModelPropertiesBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TypeSpecVisitor visitor) {
    visitor.visitModelPropertiesBlock(this);
  }
