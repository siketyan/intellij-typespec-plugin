...
public class TypeSpecSpreadObjectLiteralPropertyImpl extends TypeSpecElementImpl implements TypeSpecSpreadObjectLiteralProperty {

  public TypeSpecSpreadObjectLiteralPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TypeSpecVisitor visitor) {
    visitor.visitSpreadObjectLiteralProperty(this);
  }
