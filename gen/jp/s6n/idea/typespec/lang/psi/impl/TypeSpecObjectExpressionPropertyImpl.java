...
public class TypeSpecObjectExpressionPropertyImpl extends TypeSpecElementImpl implements TypeSpecObjectExpressionProperty {

  public TypeSpecObjectExpressionPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TypeSpecVisitor visitor) {
    visitor.visitObjectExpressionProperty(this);
  }
