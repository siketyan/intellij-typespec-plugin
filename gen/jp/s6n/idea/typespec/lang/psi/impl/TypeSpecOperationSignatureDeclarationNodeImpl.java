...
public class TypeSpecOperationSignatureDeclarationNodeImpl extends TypeSpecElementImpl implements TypeSpecOperationSignatureDeclarationNode {

  public TypeSpecOperationSignatureDeclarationNodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TypeSpecVisitor visitor) {
    visitor.visitOperationSignatureDeclarationNode(this);
  }
